...
logging_cloudwatch_access_key_id = config("LOGGING_CLOUDWATCH_ACCESS_KEY_ID", default=__optional_when_locally)
logging_cloudwatch_secret_access_key = config("LOGGING_CLOUDWATCH_SECRET_ACCESS_KEY", default=__optional_when_locally)
logging_cloudwatch_region = config("LOGGING_CLOUDWATCH_REGION", default=__optional_when_locally)
logging_cloudwatch_log_group = config("LOGGING_CLOUDWATCH_LOG_GROUP", default=__optional_when_locally)
logging_cloudwatch_create_log_group = config("AWS_CREATE_LOG_GROUP", default=True, cast=bool)
